...
- *category-{slug}.php* - Used to show a post in a given category. The category is matched by the "slug" - for example posts in category "General" (with a category slug of "general") could use a template of _category-general.php_.
